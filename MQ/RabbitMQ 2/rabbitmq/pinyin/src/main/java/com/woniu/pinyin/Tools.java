 ...
 **/
public class Tools {
    public static Hashtable<String, String> ht = new Hashtable<String, String>(10);

    public static void main(String[] args) {
        System.out.println(Tools.convert("我爱老韩"));// walh
        System.out.println(Tools.getSimple("我爱老韩"));
    }

    public static String getSimple(String arr){//我爱老韩
        StringBuilder sb = new StringBuilder();
        char[] chars = arr.toCharArray();
        for (char c:chars) {//我
            String result = convert(c+"");//wo
            if(result.length()>0)
